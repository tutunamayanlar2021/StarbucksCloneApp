...
let hContent:[HomeContent] = [
    ...
    HomeContent(contentTitle: "ufy", contentSubtitle: "", image:  #imageLiteral(resourceName: "reward")),
    ...
    HomeContent(contentTitle: "Yaza 🥳", contentSubtitle: "Yazına renk katacak kupa ve termos ailemizin yeni üyeleriyle tanışmaya hazır mısın? 🥳 Çok seveceğin yeni Starbucks® kupa ve termosları Hepsiburada’da seni bekliyor!", image:  #imageLiteral(resourceName: "t")),
    HomeContent(contentTitle: " 🍇🌬", contentSubtitle: "4 yeni kırmızı meyveli lezzetimizle yazın serinletici etkisini keşfet! 🌬", image:  #imageLiteral(resourceName: "mam.jpeg"))
